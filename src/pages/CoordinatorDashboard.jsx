              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y text-sm">
                  {filteredOrders.length === 0 ? (
                    <tr><td colSpan="6" className="text-center p-12 text-gray-400 font-bold">No logs found for current filters.</td></tr>
                  ) : (
                    filteredOrders.map((o) => {
                      const isGuest = o.voucherCode?.startsWith('G-');
                      
                      // 🚀 LOGIC: Extract Subject Name for this specific order
                      const orderDateIso = new Date(o.orderDate || o.createdAt).toISOString().split('T')[0];
                      let displaySubject = "N/A";
                      ...
                      if (o.facultyId?.assignedSubjects) {
                        ...
                        displaySubject = matchingSub ? matchingSub.split('|')[2] : "Duty/Other";
                      }
                      ...
                      return (
                        <tr key={o._id} className="hover:bg-gray-50/50 transition-colors">
                          ...
                          {/* 🚀 NEW COLUMN DATA: SUBJECT */}
                          <td className="p-4">
                            <span className="text-[11px] bg-blue-50 text-blue-700 px-2 py-1 rounded font-bold border border-blue-100 block w-max max-w-[180px] truncate" title={displaySubject}>
                              {displaySubject}
                            </span>
                          </td>
